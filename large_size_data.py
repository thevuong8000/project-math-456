...
boxes_raw_data = list(wb['Big Nutrition Data'].values)
...
# RESULT:
# Max Nutrition: 831.5
# box 43 put in coordinate (0, 0, 0)
# box 41 put in coordinate (0, 0, 1)
# box 20 put in coordinate (0, 1, 0)
# box 23 put in coordinate (0, 1, 1)
# box 17 put in coordinate (0, 1, 2)
# box 30 put in coordinate (0, 2, 0)
# box 32 put in coordinate (0, 2, 1)
# box 33 put in coordinate (0, 2, 2)
# box 12 put in coordinate (0, 2, 3)
# box 5 put in coordinate (0, 3, 0)
# box 9 put in coordinate (0, 3, 1)
# box 7 put in coordinate (0, 3, 2)
# box 8 put in coordinate (0, 3, 3)
# box 6 put in coordinate (0, 3, 4)
# box 27 put in coordinate (1, 0, 0)
# box 25 put in coordinate (1, 0, 1)
# box 10 put in coordinate (1, 0, 2)
# box 14 put in coordinate (1, 0, 3)
# box 26 put in coordinate (1, 1, 0)
# box 29 put in coordinate (1, 1, 1)
# box 28 put in coordinate (1, 1, 2)
# box 13 put in coordinate (1, 2, 0)
# box 18 put in coordinate (1, 2, 1)
# box 19 put in coordinate (1, 2, 2)
# box 16 put in coordinate (1, 2, 3)
# box 15 put in coordinate (1, 2, 4)
# box 11 put in coordinate (1, 3, 0)
# box 1 put in coordinate (1, 3, 1)
# box 3 put in coordinate (1, 3, 2)
# box 4 put in coordinate (1, 3, 3)
# box 0 put in coordinate (1, 3, 4)
# Can put 31 boxes out of 50
# Using 331.29999999999995lbs